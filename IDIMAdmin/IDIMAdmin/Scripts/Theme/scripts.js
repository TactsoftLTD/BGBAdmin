...
jQuery(function ($) {
    ...
    CMPLTADMIN_SETTINGS.sectionBoxActions = function () {
        ...
        $('section.box .actions .box_toggle').on('click', function () {
            ...
            content = $(this).parent().parent().parent().find(".content-body");
    ...
    CMPLTADMIN_SETTINGS.mainmenuScroll = function () {
        ...
        var mMenuTop = $('#main-menu-wrapper ul .open').offset().top;
        aMenuTop.push(mMenuTop);

        $("#main-menu-wrapper").scrollTop(aMenuTop[0] - height/2);
            ...
            $(".datepicker").each(function (i, e) {
                var $this = $(e),
                    options = {
                        ...
                        format: getValue($this, 'format', dateFormat),
